...
public class SessionEntityDao extends AbstractDao<SessionEntity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Gossipid = new Property(3, long.class, "gossipid", false, "GOSSIPID");
        public final static Property Gossip = new Property(4, String.class, "gossip", false, "GOSSIP");
        public final static Property Sessiontype = new Property(5, int.class, "sessiontype", false, "SESSIONTYPE");
        public final static Property Asdasd = new Property(6, boolean.class, "asdasd", false, "ASDASD");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SESSION_ENTITY' (" + //
                ...
                "'GOSSIPID' INTEGER NOT NULL ," + // 3: gossipid
                "'GOSSIP' TEXT," + // 4: gossip
                "'SESSIONTYPE' INTEGER NOT NULL ," + // 5: sessiontype
                "'ASDASD' INTEGER NOT NULL );"); // 6: asdasd
    }
    ...
    protected void bindValues(SQLiteStatement stmt, SessionEntity entity) {
        ...
        stmt.bindLong(4, entity.getGossipid());
 
        String gossip = entity.getGossip();
        if (gossip != null) {
            stmt.bindString(5, gossip);
        }
        stmt.bindLong(6, entity.getSessiontype());
        stmt.bindLong(7, entity.getAsdasd() ? 1l: 0l);
    }
    ...
    public SessionEntity readEntity(Cursor cursor, int offset) {
        SessionEntity entity = new SessionEntity( //
            ...
            cursor.getLong(offset + 3), // gossipid
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // gossip
            cursor.getInt(offset + 5), // sessiontype
            cursor.getShort(offset + 6) != 0 // asdasd
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, SessionEntity entity, int offset) {
        ...
        entity.setGossipid(cursor.getLong(offset + 3));
        entity.setGossip(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setSessiontype(cursor.getInt(offset + 5));
        entity.setAsdasd(cursor.getShort(offset + 6) != 0);
     }
